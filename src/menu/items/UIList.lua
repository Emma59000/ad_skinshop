...
---@param LabelCallback Callback for build label
---@param Current value
...
---@return nil
---@public
function RageUI.IncrementList(Label, From, To, Value, LabelCallback, Description, Style, Enabled, Callback, onListChange, Submenu)
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() then
            ...
            if CurrentMenu.Pagination.Minimum <= Option and CurrentMenu.Pagination.Maximum >= Option then
                ...
                local ListText = string.format("← %s →", LabelCallback and LabelCallback(Value) or Value)
                ...
                if Selected and (CurrentMenu.Controls.Select.Active or ((Hovered and CurrentMenu.Controls.Click.Active) and (not LeftArrowHovered and not RightArrowHovered))) then
                    ...
                    if Submenu ~= nil and type(Submenu) == "table" then
                        RageUI.NextMenu = Submenu[Value]
                    end
                end
    
                if (Enabled and Callback) then
                    Callback(Hovered, Selected, ((CurrentMenu.Controls.Select.Active or ((Hovered and CurrentMenu.Controls.Click.Active) and (not LeftArrowHovered and not RightArrowHovered))) and Selected), Value)
                end
